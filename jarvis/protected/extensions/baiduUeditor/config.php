...
return  array(
    ...
    "imagePathFormat"=> "/yii-1.1.15.022a51/demos/Lab/uploads/{yyyy}{mm}{dd}/{time}{rand:2}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
    ...
    "filePathFormat"=> "/yii-1.1.15.022a51/demos/Lab/uploads/{yyyy}{mm}{dd}/{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
